    ...
    foreach ($resultados->result() as $row) {
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="numero_control" id="numero_control" value="<?php echo $row->numero_control; ?>" readonly="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="apellidoPaterno" id="apellidoPaterno" value="<?php echo $row->apellido_paterno; ?>" readonly>
            </div>
            <div class="form-group">
                <label  for="apellidoMaterno">Apellido Materno</label>
                <input type="text" class="form-control" name="apellidoMaterno" id="apellidoMaterno" value="<?php echo $row->apellido_materno; ?>" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="domicilio" id="domicilio" value="<?php echo $row->domicilio; ?>" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="ciudad_residente" id="ciudad_residente" value="<?php echo $row->ciudad; ?>" readonly>
            </div>
            <div class="form-group">
                <label for="telefono_residente" >Telefono(No celular):</label>
                <input type="text" class="form-control" name="telefono_residente" id="telefono_residente" value="<?php echo $row->telefono; ?>" readonly>
            </div>
            <div class="form-group">
                <label for="seguridad_social">Para Seguridad Social acudir:</label>
                <input type="text" class="form-control" name="telefono_residente" id="telefono_residente" value="<?php echo $row->seguridad_social; ?>" readonly>
            </div>
            <div class="form-group">
                <label  for="numero_social" >Número Seguridad Social:</label>
                <input type="text" class="form-control" name="numero_social" id="numero_social" value="<?php echo $row->numero_social; ?>" readonly>
            </div>
